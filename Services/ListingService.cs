...
namespace HouseRentalSystem.Services
{
    public class ListingService : IListingService
    {
        ...
        public async Task<Listing> UpdateListingAsync(string listingId, UpdateListingRequest updatedListing)
        {
            ...
            existingListing.PricePerNight = updatedListing.PricePerNight != 0 ? updatedListing.PricePerNight : existingListing.PricePerNight;
            existingListing.NumberOfGuests = updatedListing.NumberOfGuests != 0 ? updatedListing.NumberOfGuests : existingListing.NumberOfGuests;
            existingListing.ThumbnailUrl = updatedListing.ThumbnailUrl ?? existingListing.ThumbnailUrl;
